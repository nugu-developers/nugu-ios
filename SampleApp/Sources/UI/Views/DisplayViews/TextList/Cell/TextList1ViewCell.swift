...
final class TextList1ViewCell: UITableViewCell {
    ...
    func configure(badgeNumber: String?, item: TextList1Template.Item?, toggleStyle: DisplayCommonTemplate.Common.ToggleStyle?) {
...
private extension TextList1ViewCell {
