...
final class ImageText3View: DisplayView {
    ...
    override func loadFromXib() {
        ...
        let view = Bundle.main.loadNibNamed("ImageText3View", owner: self)?.first as! UIView
...
extension ImageText3View: UIScrollViewDelegate {
