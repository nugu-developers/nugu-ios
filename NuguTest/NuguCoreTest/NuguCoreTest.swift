...
class NuguCoreTest: XCTestCase {
    ...
    func testSharedBuffer() {
        ...
        Observable<Int>.timer(RxTimeInterval.seconds(1), period: RxTimeInterval.milliseconds(30), scheduler: ConcurrentMainScheduler.instance)
